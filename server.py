...
if __name__ == '__main__':
    ...
    parser.add_argument('--user', dest='user', default='fw-ops', help='github user (default: Fiware-ops)',
                        action="store")
    parser.add_argument('--threads', dest='threads', default=4, help='threads to start (default: 4)',
                        action="store")
    parser.add_argument('--socks', dest='socks', default=2, help='threads to start (default: 2)',  action="store")
